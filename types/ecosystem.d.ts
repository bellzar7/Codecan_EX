...
interface EcosystemMarketMetaData {
...
interface EcosystemMarketLimits {
  amount: {
    min: number;
    max: number;
  };
...
interface EcosystemMarketPrecision {
  amount: number;
  price: number;
}
...
interface EcosystemPrecision {
  amount: number;
  price: number;
}

interface EcosystemTokenLimits {
  deposit: {
    min: number;
    max: number;
  };
