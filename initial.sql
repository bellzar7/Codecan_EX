...
CREATE TABLE `p2p_offer` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `userId` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `paymentMethodId` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
...
CREATE TABLE `user` (
  ...
  `customAddressWalletsPairFields` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`customAddressWalletsPairFields`)),
  `customRestrictionPairFields` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`customRestrictionPairFields`)),
...
--
-- Indexes for table `deposit_wallet`
--
ALTER TABLE `deposit_wallet`
    ADD PRIMARY KEY (`id`);
