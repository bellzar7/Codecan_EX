          ...
          <div className="container">
            <div className="error-wrapper relative flex flex-col items-center justify-center overflow-hidden py-12">
              <div className="error-wrapper-inner relative isolate w-full">
                <div className="underlay absolute top-[36%] left-1/2 -z-1 -translate-x-1/2 -translate-y-1/2 font-extrabold font-sans ltablet:text-[23rem] text-[8rem] text-muted-800 opacity-10 md:top-[38%] md:text-[20rem] lg:text-[26rem] dark:text-muted-300">
                  <span>404</span>
                </div>
                ...
                <div className="mt-4 text-center">
                  <h2 className="mb-2 font-normal font-sans text-3xl text-muted-800 leading-tight dark:text-muted-100">
