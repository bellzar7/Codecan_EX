...
const s = class {
  constructor(n) {
    var o, s;
    if (
      ((this._id = `tradingview_${((1_048_576 * (1 + Math.random())) | 0).toString(16).substring(1)}`),
      (this._ready = !1),
      (this._readyHandlers = []),
    ...
    ((o = n.overrides) === null || void 0 === o
      ...
      (this._options = t(e, n));
    ((s = this._options.theme) !== null && void 0 !== s
      ? s
      : "light"
    ).toLowerCase() === "dark" &&
  ...
  _create() {
    ...
    const n =
        (e =
          (t = this._options.enabled_features) === null || void 0 === t
            ? void 0
            : t.includes("iframe_loading_compatibility_mode")) !== null &&
        void 0 !== e &&
        e,
      [i, o] = this._render(!n),
      s = this._options.container,
      r = typeof s == "string" ? document.getElementById(s) : s;
    if (r === null)
  ...
  _render(t) {
    ...
    const i = ((t, e) => {
      ...
      const o = new URL(`${t || ""}`, location.href).href,
        ...
        a =
          (i = n.find((t) => t.language === r)) !== null && void 0 !== i
            ? i
            : { iso: "en", dir: "ltr" },
