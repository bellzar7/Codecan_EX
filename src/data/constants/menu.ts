export const adminMenu: IMenu[] = [
  ...
  // finance
  {
    ...
    permission: [
      ...
      "Access Deposit Wallet Management",
    ...
    menu: [
      ...
      },
      {
        ...
        subMenu: [
          ...
          {
            title: "Wallets",
            href: "/admin/finance/deposit/wallet",
      ...
      },
      {
        ...
        subMenu: [
          ...
          },
          {
            ...
            href: "/admin/finance/order/liquidity-pool",
...
export const userMenu: IMenu[] = [
  {
    ...
    menu: [
      ...
      { title: "Forex", icon: "solar:dollar-bold-duotone", href: "/forex" },
      { title: "Indices", icon: "solar:graph-bold-duotone", href: "/indices" },
      {
        title: "Stocks",
