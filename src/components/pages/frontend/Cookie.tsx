...
const CookieBanner: React.FC = () => {
  ...
  return (
    <div
      className="fixed right-0 bottom-0 z-60 mx-auto w-full p-6 sm:max-w-sm"
    ...
    >
      <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-xs dark:border-neutral-800 dark:bg-neutral-900">
        <div className="flex gap-x-4">
          ...
          <p className="text-gray-800 text-sm dark:text-neutral-200">
          ...
          <div>
            <button
              className="inline-flex items-center gap-x-2 rounded-full border border-transparent p-2 font-semibold text-gray-500 text-sm hover:bg-gray-50 disabled:pointer-events-none disabled:opacity-50 dark:text-neutral-400 dark:hover:bg-neutral-700"
