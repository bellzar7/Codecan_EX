      ...
      <div className="col-span-12 ltablet:col-span-8 lg:col-span-8">
        <div className="space-y-6 lg:max-w-xl">
          {Object.entries(themeFields).map(([color, shades]) => (
            <div className="space-y-4" key={color}>
              <h4 className="font-semibold text-md text-muted-700 dark:text-muted-200">
              ...
              <div className="grid w-full grid-cols-12 gap-x-6 gap-y-4">
                {shades.map((shade) => {
                  ...
                  return (
                    <div
                      className="col-span-12 flex items-center space-x-4 md:col-span-6 lg:col-span-4"
                      key={shade}
                    >
                      <ColorInput
