 ...
 * Handles both numbers and strings (for backward compatibility with TWD DECIMAL fields)
...
const OrdersBase = () => {
  ...
  const columnConfig: ColumnConfigType[] = [
    ...
    },
    {
      ...
      type: "number",
      sortable: true,
      getValue: (row) => safeToFixed(row.price, getPrecision("price")),
    },
    {
      field: "amount",
      label: "Amount",
      type: "number",
      sortable: true,
      getValue: (row) => safeToFixed(row.amount, getPrecision("amount")),
    },
    {
      field: "filled",
      label: "Filled",
      type: "number",
      sortable: true,
      getValue: (row) => safeToFixed(row.filled, getPrecision("amount")),
    },
    {
      field: "remaining",
      label: "Remaining",
      type: "number",
      sortable: true,
      getValue: (row) => safeToFixed(row.remaining, getPrecision("amount")),
    },
    {
      field: "cost",
      label: "Cost",
      type: "number",
      sortable: true,
      getValue: (row) => safeToFixed(row.cost, getPrecision("price")),
    },
    {
      field: "status",
      label: "Status",
      ...
      getValue: (row) => (
        <span className={resultClass(row.result)}>
          {row.profit !== null && row.profit !== undefined
            ? safeToFixed(row.profit, getPrecision("price"))
            : "PENDING"}
        </span>
      ),
    },
