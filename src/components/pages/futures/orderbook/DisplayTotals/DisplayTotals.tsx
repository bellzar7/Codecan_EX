    ...
    return (
      <div
        className={`hover-card ${
          isHovered ? "visible" : ""
        } fixed z-20 min-w-[15%] max-w-[80%] rounded-[.65rem] border-primary-500 border-l-2 bg-muted-100 p-2 text-muted-800 before:pointer-events-none before:absolute before:top-[20px] before:right-full before:-mt-[9px] before:h-0 before:w-0 before:border-[9px] before:border-transparent before:border-r-primary-500 after:pointer-events-none after:absolute after:top-[18px] after:right-full after:-mt-2 after:h-0 after:w-0 after:border-[8px] after:border-transparent after:border-r-primary-500 dark:border-primary-400 dark:bg-muted-900 dark:text-muted-200 dark:after:border-r-primary-400 dark:before:border-r-primary-400`}
        style={{
