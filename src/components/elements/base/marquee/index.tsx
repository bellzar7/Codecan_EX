  ...
  return (
    ...
    >
      ...
      {showGradients && (
        <>
          <div
            className="pointer-events-auto absolute top-0 bottom-0 left-0 z-50 flex w-40 items-center justify-center bg-linear-to-r from-white to-transparent dark:from-black dark:to-transparent"
            onMouseEnter={() => handleSideMouseEnter("left")}
            onMouseLeave={handleSideMouseLeave}
          >
            <Icon
              className={`text-black transition-opacity duration-300 dark:text-white ${
          ...
          <div
            className="pointer-events-auto absolute top-0 right-0 bottom-0 z-50 flex w-40 items-center justify-center bg-linear-to-l from-white to-transparent dark:from-black dark:to-transparent"
