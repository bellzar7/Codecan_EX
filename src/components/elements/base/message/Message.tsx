...
const Message: FC<MessageProps> = ({
  ...
  return (
    <motion.div
      ...
      className={`${
        isFixed &&
        "fixed bottom-10 left-[5%] w-[90%] sm:left-[12.5%] sm:w-[75%] md:left-[20%] md:w-[60%] lg:left-[25%] lg:w-[50%]"
      } transform-x-[-50%] z-50`}
      exit={{ y: 50, opacity: 0 }}
    ...
    >
      <div style={style}>
        {visible ? (
          <div
            className={`${className} flex items-center gap-2 border py-3 ps-4 pe-2 ${shape === "rounded-sm" ? "rounded-md" : ""}
          ...
          >
            {children ? (
              ...
              <div className="flex items-center gap-3">
                {icon ? <Icon height={24} icon={icon} width={24} /> : ""}
