...
interface PopoverContentCloseProps {
  children: React.ReactNode;
}

export const PopoverContentClose = React.forwardRef<
  HTMLDivElement,
  PopoverContentCloseProps
>((props, ref) => {
...
PopoverContentClose.displayName = "PopoverContentClose";
