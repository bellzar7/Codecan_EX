        ...
        <div className="relative h-full w-full font-sans">
          ...
          <Listbox.Button
            className={inputVariants({
              ...
              color,
              shape,
              className: `group/listbox-button relative text-start ${size === "sm" && selected?.icon ? "ps-8 pe-2" : ""}
          ...
          >
            ...
            <span
              className={`pointer-events-none absolute top-0 right-0 flex items-center justify-center ${size === "sm" ? "h-8 w-8" : ""} 
                ${size === "md" ? "h-10 w-10" : ""} 
                ${size === "lg" ? "h-12 w-12" : ""}
          ...
          >
            <Listbox.Options
              className={`slimscroll !p-2 absolute z-9999 mt-1 max-h-[300px] w-full overflow-auto border text-base shadow-lg shadow-muted-300/30 ring-1 ring-primary-500 ring-opacity-5 focus:outline-hidden sm:text-sm dark:shadow-muted-800/20 ${selected?.image ? "max-h-[201.2px]" : "max-h-60"}
