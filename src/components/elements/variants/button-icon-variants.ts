  ...
  "relative inline-flex cursor-pointer items-center justify-center gap-1 transition-all duration-300 disabled:cursor-not-allowed disabled:opacity-50",
  {
    variants: {
      ...
      shadow: {
        ...
        purple:
          "hover:enabled:shadow-purple-500/50 hover:enabled:shadow-xl dark:hover:enabled:shadow-purple-800/20",
      },
    },
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        variant: "outlined",
        className:
          "border border-success-500 text-success-500 hover:bg-success-500 hover:text-white active:enabled:bg-success-400 [&>span>.loader]:text-success-500",
      },
      {
        color: "warning",
        variant: "outlined",
...

      {
        ...
        variant: "solid",
        className:
          "border border-purple-500 bg-purple-500 text-white active:enabled:bg-purple-400 enabled:hover:bg-purple-600 [&>span>.loader]:text-muted-100",
      },
      {
        color: "purple",
        variant: "pastel",
        className:
          "bg-purple-500/10 text-purple-500 active:enabled:bg-purple-500/10 enabled:hover:bg-purple-500/20 dark:bg-purple-500/20 dark:active:enabled:bg-purple-500/10 dark:enabled:hover:bg-purple-500/30 [&>span>.loader]:text-purple-500",
      },
      {
        color: "purple",
        variant: "outlined",
        className:
          "border border-purple-500 text-purple-500 hover:bg-purple-500 hover:text-white active:enabled:bg-purple-400 [&>span>.loader]:text-purple-500",
      },
    ],
