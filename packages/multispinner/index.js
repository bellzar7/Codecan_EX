...
// Local
const _Spinners = require("./lib/spinners");
...
module.exports = class Multispinner extends Emitter {
  ...
  updateSpinner(spinnerKey) {
    ...
    const duration = spinner.endTime
      ? spinner.endTime - this.lastCompletionTime
      : 0;
    const paddedDuration = `${duration} ms`.padStart(
  ...
  calculateDurationColumnWidth() {
    const maxExpectedDuration = 99_999;
