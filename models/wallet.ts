...
import type ecosystemPrivateLedger from "./ecosystemPrivateLedger";
import type ecosystemUtxo from "./ecosystemUtxo";
    ...
    return wallet.init(
      {
        ...
        type: {
          ...
          validate: {
            isIn: {
              args: [
                ["FIAT", "SPOT", "ECO", "FUTURES", "FOREX", "STOCK", "INDEX"],
              ],
              msg: "type: Type must be one of ['FIAT', 'SPOT', 'ECO', 'FUTURES', 'FOREX', 'STOCK', 'INDEX']",
            },
          },
        },
        currency: {
