...
import type aiInvestment from "./aiInvestment";
import type author from "./author";
import type binaryOrder from "./binaryOrder";
import type ecommerceOrder from "./ecommerceOrder";
import type ecommerceReview from "./ecommerceReview";
import type ecommerceUserDiscount from "./ecommerceUserDiscount";
import type ecommerceWishlist from "./ecommerceWishlist";
import type exchangeOrder from "./exchangeOrder";
import type exchangeWatchlist from "./exchangeWatchlist";
import type forexAccount from "./forexAccount";
import type forexInvestment from "./forexInvestment";
import type icoContribution from "./icoContribution";
import type investment from "./investment";
import type invoice from "./invoice";
import type kyc from "./kyc";
import type mlmReferral from "./mlmReferral";
import type mlmReferralReward from "./mlmReferralReward";
import type notification from "./notification";
import type p2pDispute from "./p2pDispute";
import type p2pOffer from "./p2pOffer";
import type p2pPaymentMethod from "./p2pPaymentMethod";
import type p2pReview from "./p2pReview";
import type p2pTrade from "./p2pTrade";
import type providerUser from "./providerUser";
import type role from "./role";
import type stakingLog from "./stakingLog";
  ...
  implements userAttributes
{
  ...
  profile?: string;
  lastLogin?: Date;
  customAddressWalletsPairFields?: string;
  customRestrictionPairFields?: string;
    ...
    return user.init(
      {
        ...
        customAddressWalletsPairFields: {
          ...
          allowNull: true,
          get() {
            const rawData = this.getDataValue("customAddressWalletsPairFields");
            return rawData ? JSON.parse(rawData) : [];
          },
          set(fields: CustomAddressWalletsPairFields[]) {
            this.setDataValue(
              "customAddressWalletsPairFields",
              JSON.stringify(
                fields.map((field) => ({
        ...
        customRestrictionPairFields: {
          ...
          allowNull: true,
          get() {
            const rawData = this.getDataValue("customRestrictionPairFields");
            return rawData ? JSON.parse(rawData) : [];
          },
          set(fields: CustomRestrictionPairFields[]) {
            this.setDataValue(
              "customRestrictionPairFields",
              JSON.stringify(
                fields.map((field) => ({
