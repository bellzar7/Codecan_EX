...
export class MatchingEngine {
  ...
  private readonly orderQueue: Record<string, Order[]> = {};
  ...
  public static getInstance(): Promise<MatchingEngine> {
    if (!MatchingEngine.instancePromise) {
      MatchingEngine.instancePromise = (async () => {
        const instance = new MatchingEngine();
        await instance.init();
        return instance;
      })();
    }
    return MatchingEngine.instancePromise;
  }
