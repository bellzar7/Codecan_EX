...
const EVM_CHECK_INTERVAL = Number(process.env.EVM_CHECK_INTERVAL_MS) || 300_000; // 5 min default
const UTXO_CHECK_INTERVAL =
  Number(process.env.UTXO_CHECK_INTERVAL_MS) || 900_000; // 15 min default
