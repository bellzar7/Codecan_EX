...
import type { FuturesPosition } from "./queries/positions";
...
const calculateMargin = (
  ...
  const marginBigInt =
    (priceDifferenceBigInt * BigInt(1_000_000_000_000_000_000)) /
    entryPriceWithLeverageBigInt;

  // Convert margin back to number for the result
  const margin = Number(marginBigInt) / 1_000_000_000_000_000_000;
