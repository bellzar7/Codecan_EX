...
beforeEach(() => {
  ...
  models.exchangeMarket.findOne.mockResolvedValue({
    metadata: { limits: { amount: { min: 10, max: 10_000 } } },
  });
...
describe("Binary Order Service Comprehensive Tests (with OHLCV)", () => {
  test("RISE_FALL: Create & WIN scenario", async () => {
    ...
    (ensureExchange as jest.Mock)
      .mockResolvedValueOnce({
        fetchTicker: jest.fn().mockResolvedValue({ last: 20_000 }),
        fetchOHLCV: jest.fn().mockResolvedValue([]),
      })
      .mockResolvedValueOnce({
        fetchTicker: jest.fn().mockResolvedValue({ last: 20_001 }),
        fetchOHLCV: jest.fn().mockResolvedValue([
          [0, 0, 0, 0, 20_000],
          [0, 0, 0, 0, 20_001],
        ]),
  ...
  test("RISE_FALL: LOSS scenario", async () => {
    ...
    (ensureExchange as jest.Mock)
      ...
      .mockResolvedValueOnce({
        fetchTicker: jest.fn().mockResolvedValue({ last: 19_999 }),
        fetchOHLCV: jest.fn().mockResolvedValue([
          [0, 0, 0, 0, 20_000],
          [0, 0, 0, 0, 19_999],
        ]),
  ...
  test("HIGHER_LOWER: HIGHER WIN scenario", async () => {
    ...
    (ensureExchange as jest.Mock)
      ...
      .mockResolvedValueOnce({
        fetchTicker: jest.fn().mockResolvedValue({ last: 20_010 }),
        fetchOHLCV: jest.fn().mockResolvedValue([
          [0, 0, 0, 0, 20_000],
          [0, 0, 0, 0, 20_010],
        ]),
  ...
  test("HIGHER_LOWER: LOWER LOSS scenario", async () => {
    ...
    (ensureExchange as jest.Mock)
      ...
      .mockResolvedValueOnce({
        fetchTicker: jest.fn().mockResolvedValue({ last: 20_100 }),
        fetchOHLCV: jest.fn().mockResolvedValue([
          [0, 0, 0, 0, 20_000],
          [0, 0, 0, 0, 20_100],
        ]),
  ...
  test("TOUCH_NO_TOUCH: TOUCH WIN scenario (barrier touched)", async () => {
    ...
    (ensureExchange as jest.Mock)
      ...
      .mockResolvedValueOnce({
        fetchTicker: jest.fn().mockResolvedValue({ last: 20_050 }),
        fetchOHLCV: jest.fn().mockResolvedValue([
          [now, 0, 20_100, 19_900, 20_000],
          [now + 60_000, 0, 20_100, 19_900, 20_050],
        ]),
      });
  ...
  test("TOUCH_NO_TOUCH: NO_TOUCH WIN scenario (barrier never touched)", async () => {
    ...
    (ensureExchange as jest.Mock)
      ...
      .mockResolvedValueOnce({
        fetchTicker: jest.fn().mockResolvedValue({ last: 20_000 }),
        fetchOHLCV: jest.fn().mockResolvedValue([
          [now, 0, 20_500, 19_500, 20_000],
          [now + 60_000, 0, 20_500, 19_500, 20_000],
        ]),
      });
  ...
  test("TOUCH_NO_TOUCH: LOSS scenario", async () => {
    ...
    (ensureExchange as jest.Mock)
      ...
      .mockResolvedValueOnce({
        ...
        fetchOHLCV: jest.fn().mockResolvedValue([
          [now, 0, 20_100, 19_900, 20_000],
          [now + 60_000, 0, 20_100, 19_900, 20_000],
        ]),
      });
  ...
  test("CALL_PUT: CALL WIN scenario", async () => {
    ...
    (ensureExchange as jest.Mock)
      ...
      .mockResolvedValueOnce({
        fetchTicker: jest.fn().mockResolvedValue({ last: 20_150 }),
        fetchOHLCV: jest.fn().mockResolvedValue([
          [0, 0, 0, 0, 20_000],
          [0, 0, 0, 0, 20_150],
        ]),
    ...
    (ensureExchange as jest.Mock)
      ...
      .mockResolvedValueOnce({
        ...
        fetchOHLCV: jest.fn().mockResolvedValue([
          ...
          // Ensure low >= 20000
          [Date.now(), 20_000, 20_050, 20_000, 20_050],
          [Date.now() + 60_000, 20_050, 20_150, 20_050, 20_150],
        ]),
      });
  ...
  test("TURBO: Adjusting scenario to ensure WIN", async () => {
    ...
    (ensureExchange as jest.Mock)
      ...
      .mockResolvedValueOnce({
        fetchTicker: jest.fn().mockResolvedValue({ last: 20_200 }),
        fetchOHLCV: jest.fn().mockResolvedValue([
          [Date.now(), 20_000, 20_200, 20_000, 20_200],
          [Date.now() + 60_000, 20_200, 20_200, 20_200, 20_200],
        ]),
      });
  ...
  test("TURBO: DRAW scenario", async () => {
    ...
    (ensureExchange as jest.Mock)
      ...
      .mockResolvedValueOnce({
        fetchTicker: jest.fn().mockResolvedValue({ last: 20_000 }),
        fetchOHLCV: jest.fn().mockResolvedValue([
          [Date.now(), 20_000, 20_000, 20_000, 20_000],
          [Date.now() + 60_000, 20_000, 20_000, 20_000, 20_000],
        ]),
      });
