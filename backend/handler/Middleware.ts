...
export async function rateLimit(
  ...
  try {
    ...
    const limit = Number.parseInt(process.env.RATE_LIMIT || "100", 10); // Limit per window
    ...
    if (current !== null && Number.parseInt(current, 10) >= limit) {
